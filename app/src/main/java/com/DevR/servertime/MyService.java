...
public class MyService extends Service {
    ...
    public void onCreate() {
        ...
        startWidget(MainActivity.Context1);
    }
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (widFlag == 1) {
                handler.removeMessages(0);         //핸들러 종료
            }
...
*/
    ...
    private View.OnLongClickListener mViewLongClickListener = new View.OnLongClickListener() {
        ...
        public boolean onLongClick(View view) {
            ...
            if(!SetWidget.activity.isFinishing())
                SetWidget.activity.finish();        //위젯세팅 액티비티가 열려있다면 종료
            Intent intent = getPackageManager().getLaunchIntentForPackage("com.DevR.servertime");
